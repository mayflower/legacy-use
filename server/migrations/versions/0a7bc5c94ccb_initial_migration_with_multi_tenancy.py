...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ['tenant.api_definition_versions.id'],
        ),
        sa.ForeignKeyConstraint(
            ['session_id'],
            ['tenant.sessions.id'],
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['job_id'], ['tenant.jobs.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
        schema='tenant',
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        'ix_jobmessage_job_id_sequence', table_name='job_messages', schema='tenant'
    )
    op.drop_table('job_messages', schema='tenant')
    op.drop_table('job_logs', schema='tenant')
    op.drop_table('jobs', schema='tenant')
    op.drop_table('sessions', schema='tenant')
    op.drop_table('api_definition_versions', schema='tenant')
    op.drop_table('targets', schema='tenant')
    op.drop_table('api_definitions', schema='tenant')
