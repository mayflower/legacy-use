...
def upgrade(schema: str) -> None:
    op.add_column('tenants', sa.Column('clerk_user_id', sa.String(length=256), nullable=True), schema='shared')
    op.create_unique_constraint('unique_clerk_user_id', 'tenants', ['clerk_user_id'], schema='shared')



@for_each_tenant_schema
def downgrade(schema: str) -> None:
    op.drop_constraint('unique_clerk_user_id', 'tenants', schema='shared', type_='unique')
